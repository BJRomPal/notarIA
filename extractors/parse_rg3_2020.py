"""Divide 'RG 3-2020.txt' (Resolución General IGJ 3/2020) en archivos individuales por artículo.

Sin jerarquía LIBRO/TÍTULO/CAPÍTULO — 5 artículos planos.
Formato: 'ARTÍCULO N°:' o 'ARTÍCULO Nº:' (mezcla de símbolo de grado y ordinal).
"""
import re, os

BASE_DIR   = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
INPUT_FILE = os.path.join(BASE_DIR, "input/normas/sociedades/RG/2020/RG 3-2020.txt")
OUTPUT_DIR = os.path.join(BASE_DIR, "input/normas/sociedades/RG/2020/articulos_RG3-2020")

os.makedirs(OUTPUT_DIR, exist_ok=True)

SEPARADOR = "-" * 50
HEADER    = "RG: Resolución General IGJ 3/2020"
