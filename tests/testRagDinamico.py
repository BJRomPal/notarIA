...
2. Si la pregunta requiere normativas subsidiarias (ej. SAS aplicando normas de SRL o LSC), explicá la conexión si el contexto lo avala.
3. No incluya información de tipos societarios distintos al preguntado.
...
# --- Ejecución ---
pregunta = "Si una Sociedad por Acciones Simplificada (SAS) comienza a explotar una concesión de servicios públicos, ¿qué obligación legal se le impone y en qué plazo máximo debe cumplirla bajo apercibimiento de responsabilidad solidaria de los socios?"
